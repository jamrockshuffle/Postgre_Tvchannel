...
class ThursdayControllerTest {
    ...
    void create() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/thursday/create")
    ...
    void update() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/thursday/update")
                .contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk());
    ...
    void getTypes() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/thursday/get/all"))
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void getById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/thursday/get/1"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON));
    }
    ...
    void delete() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/thursday/delete/1"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
    ...
    void createDTO() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/thursday/createDTO")
                .contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk());
    ...
    void updateDTO() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/thursday/updateDTO")
                .contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk());
