...
class SundayControllerTest {
    ...
    void create() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/sunday/create")
    ...
    void update() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/sunday/update")
                .contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk());
    ...
    void getTypes() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/sunday/get/all"))
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void getById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/sunday/get/1"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON));
    }
    ...
    void delete() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/sunday/delete/1"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
    ...
    void createDTO() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/sunday/createDTO")
                .contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk());
    ...
    void updateDTO() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/sunday/updateDTO")
                .contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk());
