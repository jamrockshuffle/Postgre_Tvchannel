...
@ComponentScan(basePackages = {"com.arch.tvchannel.service.tuesday"})
@ComponentScan(basePackages = {"com.arch.tvchannel.dao.tuesday"})
...
class TuesdayServiceImplTest {
    ...
    public void findAll() throws Exception{
        ...
        List<Tuesday> list = repository.findAll();
    ...
    public void findById() throws Exception{
        ...
        Tuesday day = repository.findById(1L).get();
    ...
    public void deleteById() throws Exception{
        ...
        Optional<Tuesday> optional = repository.findById(1L);
