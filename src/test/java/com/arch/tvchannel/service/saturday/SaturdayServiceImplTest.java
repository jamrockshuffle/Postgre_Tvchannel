...
@ComponentScan(basePackages = {"com.arch.tvchannel.service.saturday"})
@ComponentScan(basePackages = {"com.arch.tvchannel.dao.saturday"})
...
class SaturdayServiceImplTest {
    ...
    public void findAll() throws Exception{
        ...
        List<Saturday> list = repository.findAll();
    ...
    public void findById() throws Exception{
        ...
        Saturday day = repository.findById(1L).get();
    ...
    public void deleteById() throws Exception{
        ...
        Optional<Saturday> optional = repository.findById(1L);
